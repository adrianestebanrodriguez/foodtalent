      ...
      <div className="w-full max-w-md">
        ...
        {done ? (
          <div className="bg-slate-900 rounded-2xl border border-slate-800 p-8 text-center">
            ...
            <p className="text-slate-400 text-sm mb-6">Tu contraseña se ha restablecido correctamente.</p>
          ...
          <form onSubmit={handleSubmit} className="bg-slate-900 rounded-2xl border border-slate-800 p-6 sm:p-8 space-y-5">
            ...
            <button type="submit" disabled={loading}
              ...
              {loading ? <><Loader2 className="w-4 h-4 animate-spin" /> Actualizando...</> : "Restablecer contraseña"}
            </button>
          </form>
        )}
      </div>
...
// 2. Componente exportado envuelto en Suspense
